...
#define CFG_CTS_DRIVER_MINOR_VERSION        34
#define CFG_CTS_DRIVER_PATCH_VERSION        0

#define CFG_CTS_DRIVER_VERSION              "v1.34.0"
...
#define CONFIG_CTS_SPI_HOST
    ...
    #define CFG_CTS_SPI_SPEED_KHZ               6000u
...
#define CFG_CTS_FIRMWARE_IN_FS
    ...
    #define CFG_CTS_FIRMWARE_FILENAME       "ICNL9911.bin"        //for beidou B CW
	#define CFG_CTS_FIRMWARE_FILENAME_CWE    "ICNL9911_cwe.bin"   //for beidou E CW
    #define CFG_CTS_FIRMWARE_FILENAME_LC   "ICNL9911_lc.bin"
    #define CFG_CTS_FIRMWARE_FILEPATH       "/etc/firmware/ICNL9911.bin"       //for beidou B CW
	#define CFG_CTS_FIRMWARE_FILEPATH_CWE   "/etc/firmware/ICNL9911_cwe.bin"   //for beidou E CW
    #define CFG_CTS_FIRMWARE_FILEPATH_LC   "/etc/firmware/ICNL9911_lc.bin"
