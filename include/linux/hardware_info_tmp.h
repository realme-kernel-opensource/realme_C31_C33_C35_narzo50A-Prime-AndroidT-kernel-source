...
#define HARDWARE_SUB_MATCH_INFO_GET                 _IOWR(HARDWARE_ID, 0x2A, char[HARDWARE_MAX_ITEM_LONGTH])            //  sub match info
...
#define HARDWARE_SAR_GET                            _IOWR(HARDWARE_ID, 0x33, char[HARDWARE_MAX_ITEM_LONGTH])            //  sar sensor

#ifdef OPLUS_FEATURE_CAMERA_COMMON
#define HARDWARE_MACRO_CAM_GET                      _IOWR(HARDWARE_ID, 0x3C, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_MACRO_CAM_MOUDULE_ID_GET           _IOWR(HARDWARE_ID, 0x3D, char[HARDWARE_MAX_ITEM_LONGTH])
